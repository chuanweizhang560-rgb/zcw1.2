...
public:
  ...
  void getWarpMatrixAffine(const vk::AbstractCamera &cam, const Vector2d &px_ref, const Vector3d &f_ref, const double depth_ref, const Sophus::SE3d &T_cur_ref,
                           const int level_ref, 
  ...
  void getWarpMatrixAffineHomography(const vk::AbstractCamera &cam, const V2D &px_ref,
                                     const V3D &xyz_ref, const V3D &normal_ref, const Sophus::SE3d &T_cur_ref, const int level_ref, Matrix2d &A_cur_ref);
